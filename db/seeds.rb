...
tests = Test.create!([
  {title: 'Test1', level: 0, category_id: categories[0].id, timer: 600, user_id: admin.id},
  {title: 'Test2', level: 0, category_id: categories[0].id, timer: 600, user_id: admin.id},
  {title: 'Test3', level: 1, category_id: categories[1].id, timer: 600, user_id: admin.id},
  {title: 'Test4', level: 1, category_id: categories[1].id, timer: 600, user_id: admin.id},
  {title: 'Test5', level: 2, category_id: categories[0].id, timer: 600, user_id: admin.id}
])
